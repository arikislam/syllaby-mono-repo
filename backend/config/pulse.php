    ...
    'recorders' => [
        Recorders\CacheInteractions::class => [
            ...
            'groups' => [
                ...
                '/^tiktok.creator_info:.*/' => 'tiktok.creator_info:*',
                '/^editor-trialing-exports:.*/' => 'editor-trialing-exports:*',
                '/^faceless-trialing-exports:.*/' => 'faceless-trialing-exports:*',
                '/^edited-faceless-trialing-exports:.*/' => 'edited-faceless-trialing-exports:*',
                // '/:\d+/' => ':*',
            ],
        ],
        ...
        Recorders\Exceptions::class => [
            ...
            'sample_rate' => env('PULSE_EXCEPTIONS_SAMPLE_RATE', 0.4),
        ...
        Recorders\Queues::class => [
            ...
            'sample_rate' => env('PULSE_QUEUES_SAMPLE_RATE', 0.4),
            'ignore' => [
                // '/^Package\\\\Jobs\\\\/',
            ],
        ],
        ...
        Recorders\SlowJobs::class => [
            ...
            'sample_rate' => env('PULSE_SLOW_JOBS_SAMPLE_RATE', 0.7),
            'threshold' => env('PULSE_SLOW_JOBS_THRESHOLD', 180000),
            'ignore' => [
                // '/^Package\\\\Jobs\\\\/',
            ],
        ],
        ...
        Recorders\SlowOutgoingRequests::class => [
            ...
            'sample_rate' => env('PULSE_SLOW_OUTGOING_REQUESTS_SAMPLE_RATE', 0.4),
            'threshold' => env('PULSE_SLOW_OUTGOING_REQUESTS_THRESHOLD', 800),
            'ignore' => [
        ...
        Recorders\SlowQueries::class => [
            ...
            'sample_rate' => env('PULSE_SLOW_QUERIES_SAMPLE_RATE', 0.7),
        ...
        Recorders\SlowRequests::class => [
            ...
            'sample_rate' => env('PULSE_SLOW_REQUESTS_SAMPLE_RATE', 0.2),
            'threshold' => env('PULSE_SLOW_REQUESTS_THRESHOLD', 1000),
            'ignore' => [
                '#^/'.env('PULSE_PATH', 'pulse').'$#', // Pulse dashboard...
                '#^/telescope#', // Telescope dashboard...
                '#^/horizon#', // Telescope dashboard...
            ],
        ],
        ...
        Recorders\UserRequests::class => [
            ...
            'sample_rate' => env('PULSE_USER_REQUESTS_SAMPLE_RATE', 0.2),
            'ignore' => [
